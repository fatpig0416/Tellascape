...
class LiveStation extends Component {
  constructor(props) {
    super(props);
  ...
  _fetchData = val => {
    this.props.navigation.setParams({ screenTitle: 'LiveStation' });
    ...
    if (val === true) {
      if (
        ...
        let req = {
          ...
          onFail: error => {
            Alert.alert('Live Station', error, [{ text: 'OK', onPress: () => this.props.navigation.goBack() }]);
          },
        };
