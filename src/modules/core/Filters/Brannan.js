    ...
    <Node
        ...
        uniforms={{
            ...
            inputImageTexture2: resolveAssetSource(
                require(`${PATH}filters/brannanProcess.png`)
            ),
            inputImageTexture3: resolveAssetSource(
                require(`${PATH}filters/brannanBlowout.png`)
            ),
            inputImageTexture4: resolveAssetSource(
                require(`${PATH}filters/brannanContrast.png`)
            ),
            inputImageTexture5: resolveAssetSource(
                require(`${PATH}filters/brannanLuma.png`)
            ),
            inputImageTexture6: resolveAssetSource(
                require(`${PATH}filters/brannanScreen.png`)
            ),
        }}
    />
);
