...
export const Sutro = ({ children: inputImageTexture }) => (
    <Node
        ...
        uniforms={{
            ...
            inputImageTexture3: resolveAssetSource(
                require(`${PATH}filters/sutroMetal.png`)
            ),
            inputImageTexture4: resolveAssetSource(
                require(`${PATH}filters/softLight.png`)
            ),
            inputImageTexture5: resolveAssetSource(
                require(`${PATH}filters/sutroEdgeBurn.png`)
            ),
            inputImageTexture6: resolveAssetSource(
                require(`${PATH}filters/sutroCurves.png`)
            ),
        }}
    />
);
