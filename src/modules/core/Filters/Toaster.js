    ...
    <Node
        ...
        uniforms={{
            ...
            inputImageTexture2: resolveAssetSource(
                require(`${PATH}filters/toasterMetal.png`)
            ),
            inputImageTexture3: resolveAssetSource(
                require(`${PATH}filters/toasterSoftLight.png`)
            ),
            inputImageTexture4: resolveAssetSource(
                require(`${PATH}filters/toasterCurves.png`)
            ),
            inputImageTexture5: resolveAssetSource(
                require(`${PATH}filters/toasterOverlayMapWarm.png`)
            ),
            inputImageTexture6: resolveAssetSource(
                require(`${PATH}filters/toasterColorShift.png`)
            ),
        }}
    />
);
